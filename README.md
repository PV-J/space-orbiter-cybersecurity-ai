...
python anomaly_detection.py # under computer_vision/
python telemetry_classification.py # under deep_learning/
python adaptive_defense_rl.py # under reinforcement_learning/
